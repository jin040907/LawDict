...
- 🤖 **고정밀 예측 모델**: CatBoost 기반 머신러닝 모델로 법안 처리 결과 예측
- 📊 **시각화 대시보드**: 예측 확률을 도넛 차트로 직관적으로 표시
- 🔍 **고급 검색 기능**: 법안명, 발의자명, 발의일 다중 필터 지원
- 💬 **AI 챗봇**: OpenAI GPT 모델 기반 실시간 질의응답 시스템
- 📰 **뉴스 연동**: 유사 법안 관련 최신 뉴스 자동 수집 및 표시
- 📈 **종합 리포트**: 7개 섹션으로 구성된 상세 분석 리포트
...
1. **챗봇 패널**: 상세 페이지 오른쪽 사이드바
2. **질문 입력**: 법안 분석 내용에 대한 질문 입력
3. **질문 예시**:
   - "이 법안의 예측 확률은 얼마인가요?"
   - "주요 내용을 요약해주세요"
   - "유사한 법안은 무엇인가요?"
   - "사회적 영향은 무엇인가요?"
4. **답변 확인**: AI가 리포트 내용을 바탕으로 답변 제공
5. **대화 이력**: 스크롤하여 이전 대화 확인 가능

### 고급 기능

- **빠른 미리보기**: 법안명에 마우스 오버 시 미리보기 모달 표시
- **반응형 디자인**: 모바일, 태블릿, 데스크톱 지원
- **실시간 업데이트**: 검색 결과 실시간 반영
